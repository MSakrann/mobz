...
import type { ImageAsset } from "@house/data/mocks/home";
import { useSceneStore } from "@house/hooks/scene/use-scene-store";
import { subscribeToTicker } from "@house/lib/animation/ticker";
import { loadFrames, pickFrameTier } from "@house/lib/scene/frames";
import { isBotAgent } from "@house/utils/is-bot-agent";
import { canvasOpacity, sequenceFrame } from "@house/utils/timeline/scene";
...
export const SequenceCanvas = ({ p, active, poster }: SequenceCanvasProps) => {
  ...
  return (
    <animated.div className="absolute inset-0 z-1" style={{ opacity }}>
      <Image
        src={poster.src}
        alt={poster.alt}
        fill
