...
import { scrollTo } from "@house/utils/scroll-to";
...
function ScrollController() {
  ...
  useEffect(() => {
    ...
    const lenis = new Lenis({
      smoothWheel: true,
      // In-page `#hash` links (footer nav, dock menu, CTAs) scroll through
      // Lenis instead of jumping natively — no per-link click handler needed.
      anchors: true,
      // syncTouch: true,
    });
