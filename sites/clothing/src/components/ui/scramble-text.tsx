...
import { observeReveal } from "@clothing/lib/animation/reveal";
import { tie } from "@clothing/lib/text/tie";
...
import { useScrambleText } from "@clothing/hooks/use-scramble-text";
