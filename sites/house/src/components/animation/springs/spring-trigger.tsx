...
import { Tags } from "@house/types/springs";
import { useSpringTrigger } from "@house/hooks/animation/use-spring-trigger";
import { TriggerPos } from "@house/components/animation/springs/progress-trigger";
