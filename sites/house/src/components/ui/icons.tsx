...
/** The hexagon mark — an isometric cube with one solid face. */
export const LogoMark = ({ className }: IconProps) => (
  <svg {...base} strokeWidth={1.8} className={className}>
    <path d="M12 2.5L3.5 7.5v9l8.5 5 8.5-5v-9L12 2.5z" />
    <path d="M7.5 10l3.5-2" />
    <path d="M12 12.5v6l5.5-3.2v-6L12 12.5z" fill="currentColor" stroke="none" />
  </svg>
);
