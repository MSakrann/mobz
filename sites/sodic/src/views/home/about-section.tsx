...
import { Inview } from "@sodic/components/animation/springs/in-view";
import { CtaButton } from "@sodic/components/ui/cta-button";
import { DragSequenceVideo } from "@sodic/components/ui/drag-sequence-video";
import { Eyebrow } from "@sodic/components/ui/eyebrow";
import { HighlightGlyph } from "@sodic/components/ui/icons/highlight-glyph";
import { ParallaxMedia } from "@sodic/components/ui/parallax-media";
import { QuoteGlyph } from "@sodic/components/ui/icons/quote-glyph";
import { WORD_GAP_EM, fade, fadeUp, fadeUpShort, revealConfig, revealConfigSnappy } from "@sodic/lib/springs/reveal";
import type { HighlightItem, HomeContent } from "@sodic/data/mocks/home";
