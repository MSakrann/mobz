 ...
 */
import type { HeroProps } from "@brewns/components/hero";
import type { LocationsProps } from "@brewns/components/locations";
import type { MenuProps } from "@brewns/components/menu";
import type { OrderProps } from "@brewns/components/order";
import type { PhilosophyProps } from "@brewns/components/philosophy";
...
export const heroContent: HeroProps = {
  ...
  media: {
    src: "/assets/brewns/hero/models.glb",
...
export const menuContent: MenuProps = {
  swirlMask: "/assets/brewns/shared/swirl-mask.webp",
  intro: {
  ...
  cta: {
    ...
    receipt: {
      src: "/assets/brewns/menu/menu-receipt.webp",
      width: 832,
      height: 1890,
    },
  },
  items: [
    {
      ...
      price: "$2.50",
      media: {
        src: "/assets/brewns/menu/menu-espresso.webp",
    ...
    },
    {
      ...
      price: "$4.20",
      media: {
        src: "/assets/brewns/menu/menu-latte.webp",
    ...
    },
    {
      ...
      price: "$4.50",
      media: {
        src: "/assets/brewns/menu/menu-iced-coffee.webp",
    ...
    },
    {
      ...
      price: "$3.80",
      media: {
        src: "/assets/brewns/menu/menu-cinnamon.webp",
...
export const locationsContent: LocationsProps = {
  ...
  dial: {
    dial: {
      src: "/assets/brewns/locations/clock.webp",
      alt: "A clock face marking the hours",
      width: 1308,
      height: 1308,
    },
    cup: {
      src: "/assets/brewns/locations/cup.webp",
...
export const orderContent: OrderProps = {
  background: {
    src: "/assets/brewns/order/bg-table.webp",
    alt: "Two matcha cakes on brewns plates on a steel side table",
    width: 1440,
    height: 800,
  },
  printer: {
    src: "/assets/brewns/order/printer.webp",
    alt: "",
    width: 404,
    height: 72,
  },
  receipt: {
    ...
    cup: {
      src: "/assets/brewns/order/matcha-cup.webp",
